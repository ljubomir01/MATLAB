...
subplot (3, 1, 2), stem (0:length(y)-1, y_dir_sim'), title ('Odziv sistema dobijen simulacijom kaskadnog modela, celije realizovane pomocu direktne realizacije');
subplot (3, 1, 3), stem (0:length(y)-1, y_tran_sim'), title ('Odziv sistema dobijen simulacijom kaskadnog modela, celije realizovane pomocu transponovane direktne realizacije');
%crtanje gresaka
figure
